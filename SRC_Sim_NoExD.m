%%% Runs SRC WITHOUT exchange and B2. %%%

function [Sol, Bounds, Subsets] = SRC_Sim_NoExD(Trials, Iterations, N, Runs, FA_SPGR, FA_SSFP0, FA_SSFP180, TR_SPGR, TR_SSFP, Data)
