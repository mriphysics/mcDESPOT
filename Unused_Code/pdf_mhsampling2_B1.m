...
Upper = [1.25 0.5 0.30 0.80 20 10 0.15 0.03]; Lower = [0.20 0.1 0.05 0.05 1 1 0.04 0.01]; % Narrower.
% Upper = [3 1.5 1 1 40 20 0.2 0.05]; Lower = [0.001 0.001 0.001 0.001 0.001 0.001 0.001 0.001]; % Wider.
Steps = 500; nTrials = 1;
