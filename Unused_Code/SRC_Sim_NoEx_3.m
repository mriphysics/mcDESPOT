function [Sol, Bounds, Subsets] = SRC_Sim_NoEx_3(Trials, Iterations, N, Runs, FA_SPGR, FA_SSFP0, FA_SSFP180, TR_SPGR, TR_SSFP, Data)
...
for nn = 1:Runs
    ...
    %M0F_LB(1) = 0; M0F_UB(1) = 0.5; %Delta_LB(1) = -pi; Delta_UB(1) = pi;
