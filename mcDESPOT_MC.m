...
Realisations = 1000; Trials = 5000; Iterations = 7; N = 50; Runs = 1; Params = 6;
...
parfor tt = 1:Realisations
    ...
    %[Solution(tt,:), ~, ~] = SRC_Sim_NoEx(Trials, Iterations, N, Runs, FA_SPGR, FA_SSFP0, FA_SSFP180, TR_SPGR, TR_SSFP, Data_NN);
